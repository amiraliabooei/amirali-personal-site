...
export default function Header({ data, element, resume }) {
                            ...
                            <section>
                                ...
                                <div className={styled.headerUlenPc}>
                                    <nav className={styled.headerUlNaven}>
                                        ...
                                        <a href={resume.Link} key={resume.id} target="_blank" className={styled.headerDownloadResume}>
                                ...
                                >
                                    <nav className={styled.headerUlNavenMobile}>
                                        ...
                                        <a href="#projects">Projects</a>
                                        <a href="#contact">Contact</a>
                                        <a href={resume.Link} key={resume.id} target="_blank" className={styled.headerDownloadResumeMobile}>
